...
Version  : 1.2.6
Release  : 4
URL      : http://mirrors.tummy.com/pub/archive.xfce.org/src/panel-plugins/xfce4-sensors-plugin/1.2/xfce4-sensors-plugin-1.2.6.tar.bz2
Source0  : http://mirrors.tummy.com/pub/archive.xfce.org/src/panel-plugins/xfce4-sensors-plugin/1.2/xfce4-sensors-plugin-1.2.6.tar.bz2
...
%prep
%setup -q -n xfce4-sensors-plugin-1.2.6
...
export LANG=C
export SOURCE_DATE_EPOCH=1496715419
